...
from BlockchainSpider.items import InternalTransactionItem, BlockNumberItem
from BlockchainSpider.spiders.blocks.web3 import Web3BlocksSpider
from BlockchainSpider.utils.url import QueryURLBuilder


class BlocksETH2Spider(Web3BlocksSpider):
