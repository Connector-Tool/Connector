...
from BlockchainSpider.items.block import TransactionMotifItem, InternalTransactionItem
...
class MetaWeb3Blocks2Spider(MetaWeb3BlocksSpider):
    name = 'blocks.eth2'
    net = 'eth'
    ...
    def start_requests(self):
        ...
        yield from super(MetaWeb3Blocks2Spider, self).start_requests()
